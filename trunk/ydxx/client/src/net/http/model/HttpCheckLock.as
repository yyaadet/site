package net.http.model
{
	...
	public class HttpCheckLock extends HttpBase
	{
		private var _pw:String = "";

		public function HttpCheckLock()
		{
			super();
		}
		...
		{
			httpService.url = HttpURL.CHECK_LOCK_PW;
		...
		override protected function onGetInfo(evt:ResultEvent):void
		{
			...
			//派发事件，通知外面信息获取成功
			var e:HttpRespEvent = new HttpRespEvent(HttpRespEvent.CHECK_LOCK_PW);
